...
export function FounderStorySection() {
  return (
    <section style={{ background: "#1a0f05" }}>
          <div
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, fontSize: "clamp(13px, 1.2vw, 15px)", color: "rgba(245,232,208,0.65)", lineHeight: 1.85, marginBottom: "1rem" }}>
                Cresci em <strong style={{ color: "#c47820", fontWeight: 600 }}>Iguatama</strong>, uma cidade pequenininha no coração de Minas Gerais, onde fazer quitanda é tradição. Quitanda, para nós mineiros, são aqueles lanches caseiros preparados na hora para o café da manhã ou da tarde — simples, fresquinhos e cheios de afeto.
              </p>

              <p style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, fontSize: "clamp(13px, 1.2vw, 15px)", color: "rgba(245,232,208,0.65)", lineHeight: 1.85, marginBottom: "1rem" }}>
                Na minha família, essa tradição sempre esteve presente. Minha mãe, <strong style={{ color: "#c47820", fontWeight: 600 }}>Marília</strong>, e minha avó <strong style={{ color: "#c47820", fontWeight: 600 }}>Geni</strong> sempre foram excelentes quitandeiras. Fazer pão de queijo para elas nunca foi apenas uma receita — era parte da vida.
              </p>
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, fontSize: "clamp(13px, 1.2vw, 15px)", color: "rgba(245,232,208,0.65)", lineHeight: 1.85 }}>
                E de tanto testar, nasceu a oportunidade de oferecer ao público campista o <strong style={{ color: "#c47820", fontWeight: 600 }}>pão de queijo mineiro de verdade</strong> — o caseiro, o original. E o trem ficou bão. Quem experimenta, ama.
              </p>
            </div>
          </div>
    </section>
