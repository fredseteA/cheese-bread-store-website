  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-cheese-gold shadow-elevated hover:shadow-card text-base px-8 py-3",
        whatsapp: "bg-minas-green text-accent-foreground hover:bg-minas-light shadow-soft",
        cart: "bg-terracotta text-secondary-foreground hover:bg-terracotta-dark shadow-soft",
        soldout: "bg-muted text-muted-foreground cursor-not-allowed opacity-60",
      },
      size: {
